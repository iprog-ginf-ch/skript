...
Erstellen Sie im Ordner \graybgtexttt{01\_turtle-grundlagen} die Python-Datei \graybgtexttt{langsames\_quadrat.py}. Erstellen Sie darin ein Python-Programm, welches ein Quadrat zeichnet. Folgende Bedingungen sollen eingehalten werden:
...
\end{cleancode}
	...
	\begin{enumerate}
	\item Erstellen Sie in Python eine neue Python-Scratch-Datei: Führen Sie dazu einen Rechtsklick auf \graybgtexttt{Scratches and Consoles} aus. Wählen Sie dann \graybgtexttt{New} und \graybgtexttt{New Scratch File} aus. Es öffnet sich ein Fenster. Suchen Sie nach \graybgtexttt{Python} und wählen Sie es mit einem Klick aus. Es wird eine neue Python-Datei erstellt.
...
\begin{hinweis}
Was ist eine \textbf{Scratch-Datei}? Ein Zitat\footnote{\url{https://www.jetbrains.com/help/idea/scratches.html}} von der JetBrains Website: \say{Sometimes you may need to create temporary notes or draft up some code outside the project context. Instead of switching to a different application, you can use \textbf{scratch files} and scratch buffers.} \\
Was ist ein \textbf{Scratch-Buffer}? Noch ein Zitat von der JetBrains Website: \say{Scratch buffers are simple text files without any coding assistance features.}
\end{hinweis}
