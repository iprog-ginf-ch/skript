...
\begin{enumerate}
\item Erstellen Sie den Ordner \graybgtexttt{01\_turtle-grundlagen} und zwei Python-Dateien (\graybgtexttt{bsp\_1.py} und \graybgtexttt{bsp\_2.py}). Die Datei- und Ordnerstruktur sollte nun wie in \autoref{figure-dir-structure-02} aussehen.
...
\item Lösen Sie anschliessend die Aufgaben aus dem Aufgabenpaket \say{01 Turtle-Grundlagen} auf der Website \url{https://iprog.ginf.ch}.
\end{enumerate}
